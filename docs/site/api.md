...
- 通知渠道：`/api/v1/webhook-endpoints/`（`channel_type`）、`/api/v1/notification-subscriptions/`、`/api/v1/notification-events/`、`/api/v1/in-app-messages/`；详见[通知渠道与系统消息订阅](notification-channels.md)。
