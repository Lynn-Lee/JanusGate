...
- 通知渠道：`/api/v1/webhook-endpoints/`（含 `channel_type`）、`/api/v1/system-message-subscriptions/`、`/api/v1/notification-events/`、`/api/v1/in-app-messages/`；详见[通知渠道扩展](notification-channels.md)。
