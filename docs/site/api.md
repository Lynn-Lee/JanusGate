...
- Operate / password-change / activity / online-session logs：`/api/v1/operate-logs/`、`/api/v1/password-change-logs/`、`/api/v1/activity-logs/` 与 `/api/v1/online-sessions/`（#t78；详见[分类审计](classified-audit.md)）。
