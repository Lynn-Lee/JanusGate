...
- Audit：`/api/v1/audits/events`、`/api/v1/audits/typed`、`/api/v1/audits/ftp-logs`、`/api/v1/audits/job-logs`、`/api/v1/audits/online-sessions`、`/api/v1/audits/reports/summary`、`/api/v1/audits/reports/compliance`。分类日志全部进入 hash chain；详见[审计类型](audit-types.md)。
- Session ops：`/api/v1/session-ops/sessions/{id}/shares`、`/joins`、`/endpoints`、`/endpoint-rules`、`/storage-backends`。
