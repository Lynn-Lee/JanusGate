...
app.include_router(notification_subscriptions.subscriptions_router, prefix="/api/v1")
app.include_router(notification_subscriptions.events_router, prefix="/api/v1")
app.include_router(notification_subscriptions.inbox_router, prefix="/api/v1")
