...
_ASSET_TYPE = "asset"
_REPORT_FORBIDDEN_FIELDS = ("metadata", "message", "resource_id", "session_id")
...
async def create_leak_password(
    ...
    """写入 SHA-256。明文只用于计算哈希，响应永不回显 password。"""
...
async def _execute_report(*, template_key: str, tenant_id: str) -> dict[str, Any]:
    ...
    for forbidden in _REPORT_FORBIDDEN_FIELDS:
