"""Phase 4 webhook endpoint management API routes，#t75 扩展渠道类型。"""
import hashlib
import json
...
async def create_webhook_endpoint(
    ...
    except ChannelTargetError as exc:
    ...
    endpoint = WebhookEndpoint(
        ...
        credential_encrypted=encrypt_field(target.credential) if target.credential else None,
