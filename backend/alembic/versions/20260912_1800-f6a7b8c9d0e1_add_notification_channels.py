"""add notification channel fields, subscriptions and inbox (#t75)
...
def upgrade() -> None:
    ...
    op.add_column("webhook_endpoints", sa.Column("recipient", sa.String(length=255), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column("webhook_endpoints", "recipient")
