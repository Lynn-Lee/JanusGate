...
function installFetch() {
  return vi.fn(async (input: RequestInfo | URL, init?: RequestInit) => {
    ...
    return Response.json({ id: 'session-1', asset_id: '1', account_id: 'root', connector_id: 'connector-1', protocol: 'ssh', status: 'active', connection_url: 'ssh://10.0.0.10', workflow_request_id: 'req-1', jit_grant_id: 'grant-1', created_at: '2026-07-01T00:03:00Z', updated_at: '2026-07-01T00:03:00Z', closed_at: null, audit_event_ids: [] });
  });
}
...
describe('MVP pages', () => {
  ...
  it('shows Workflow request and active grant panels and creates a cached session', async () => {
